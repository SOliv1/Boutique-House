...
- In order (checkout) models, it's as simple as importing country field from django_countries.fields.  line 7
...
- should be able to see the *profile template*
  ...
  - then delete the accounts/logout then add profiles to the browser to see the user profile page
  - commit changes - add profile app

# Profile App - Part 3 & 4

- Update *django-allauth base.html*
